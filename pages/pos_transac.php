                ...
                for($i=1; $i<=$countID; $i++)
                  {
                    ...
                    $query111 = "INSERT INTO `transaction`
                               (`TRANS_ID`, `CUST_ID`, `NUMOFITEMS`, `SUBTOTAL`, `LESSGST`, `NETGST`, `ADDGST`, `GRANDTOTAL`, `CASH`, `DATE`, `TRANS_D_ID`)
                               VALUES (Null,'{$customer}','{$countID}','{$subtotal}','{$lessgst}','{$netgst}','{$addgst}','{$total}','{$cash}','{$date}','{$today}')";
