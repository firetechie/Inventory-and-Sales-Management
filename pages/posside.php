<!-- SIDE PART NA SUMMARY -->
        ...
        <?php  
                  ...
                  $lessgst = ($total / 1.12) * 0.12;
                  $netgst = ($total / 1.12);
                  $addgst = ($total / 1.12) * 0.12;
          ...
          <div class="form-group row mb-2">
            ...
            <div class="col-sm-7">
              <div class="input-group mb-2">
                ...
                <input type="text" class="form-control text-right " value="<?php echo number_format($lessgst, 2); ?>" readonly name="lessgst">
              </div>
            </div>
          ...
          <div class="form-group row mb-2">
            ...
            <div class="col-sm-7">
              <div class="input-group mb-2">
                ...
                <input type="text" class="form-control text-right " value="<?php echo number_format($netgst, 2); ?>" readonly name="netgst">
              </div>
            </div>
          ...
          <div class="form-group row mb-2">
            ...
            <div class="col-sm-7">
              <div class="input-group mb-2">
                ...
                <input type="text" class="form-control text-right " value="<?php echo number_format($addgst, 2); ?>" readonly name="addgst">
              </div>
            </div>
